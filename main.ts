...
namespace Servo {
    ...
    */
    //% blockId=setServo block="Servo index|%index|degree %degree"
    //% weight=85
    ...
    */
    ...
    export function GeekServo(index: number, degree: number): void {
        if (!initialized) {
            initPCA9685()
        }
        // 50hz: 20,000 us
    ...
    */
    //% blockId=setServoPulse block="Servo index|%index|pulse %pulse"
    //% weight=85
    ...
    */
    //% blockId=setServoOnOff block="Servo index|%index|on %on|off %off"
    //% weight=85
